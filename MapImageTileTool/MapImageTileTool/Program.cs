...
namespace MapImageTileTool
{
    public class DisplayInfo
    {
        ...
        public int DisplaySqX { get; set; }
        public int DisplaySqY { get; set; }
    ...
    class MapReader<T>
    {
        ...
        public void SetMapArray()
        {
            ...
            using (StreamWriter file = new StreamWriter(infoPath))
        ...
        public T ResizeMap(string fileName)
        {
        ...
        class Program
        {
            ...
            static void Main(string[] args)
            {
                ...
                else
                {
                    ...
                    {
                        reader = new MapReader<IMaps>(readerOptions);
                    }
                }
